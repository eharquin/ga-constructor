// Conformal null-basis display — re-express MV coefficients in {e1, e2, eo1..3,
// einf1..3} for readability (the CCGA analog of CGA's e0/einf display). A linear
// change of basis on the 8 generators, extended to all 256 blades once at load by
